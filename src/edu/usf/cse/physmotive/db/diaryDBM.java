...
public class DiaryDBM
{
    ...
    public boolean update(long id, String Name, long ht, long wt, long age, long gender, String note, long usr)
    {
	String timeStamp = new Timestamp(Calendar.getInstance().getTimeInMillis()).toString();
	String whereClause;
	ContentValues values = new ContentValues();
    ...
    {
	String[] columns = new String[] { ID, NAME, EUSR, EDATE, UUSR, UDATE, DEL };
	String whereClause = ID + "=" + id;
